	...
	dap.configurations.go = {
		{
			...
			name = "MAAD2",
			request = "launch",
			-- program = "/usr/local/google/home/cdar/goog/v2k-core/mfit/research/maad/maad.go analyze --db /usr/local/google/home/cdar/goog/app-discovery/demo/demodb",
			program = "/usr/local/google/home/cdar/goog/v2k-core/mfit/research/maad/maad.go",
      args = {"analyze", "--db", " /usr/local/google/home/cdar/goog/app-discovery/demo/demodb/"},
